...
function Szkola(){
    ...
    const { articeWithPicture } = useParams()
    const picture = defaultData[articeWithPicture-1].picture;
    const title = defaultData[articeWithPicture-1].title;
    // console.log(articeWithPicture);
    ...
    return(
            ...
            <div className='akt'>
                ...
                <hr></hr>
                    ...
                    <div className="szkol-zdj-tit">
                        <h3>Zdjęcia</h3>
                    </div>
                        <div className="szkol-zdj">
                            <div className="zdj-elem">
                                <img alt="Obrazek4" id="obrazki-main" src={picture}/>
